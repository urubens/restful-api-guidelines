...
[#113]
== {SHOULD} avoid versioning [TO VALIDATE]
...
`application/x.cytomine+json;version=2`. For incompatible changes, a new
...
[source,http]
----
Accept: application/x.cytomine+json;version=2
----
...
[source,http]
----
Content-Type: application/x.cytomine+json;version=2
----
