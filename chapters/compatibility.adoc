...
`application/x.vendor+json;version=2`. For incompatible changes, a new
...
[source,http]
----
Accept: application/x.vendor+json;version=2
----
...
[source,http]
----
Content-Type: application/x.vendor+json;version=2
----
